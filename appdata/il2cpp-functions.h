...
DO_APP_FUNC(void, MessageWriter_WriteUInt32, (MessageWriter* __this, uint32_t value, MethodInfo* method), "Hazel, System.Void Hazel.MessageWriter::Write(System.UInt32)");
